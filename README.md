...
- **Статистичний аналіз** - Z-статистика, p-value, довірчі інтервали
- **Інтерпретація результатів** - автоматичне пояснення висновків
- **Детальні звіти** - повна статистична інформація про тестування
...
1. **Генерація:** Створюється N випадкових чисел [0,1)
...
**Попередні версії:**
- v2.2-modular: Модульна архітектура, поліпшена організація коду
...
**Попередні версії:**
- v2.2: Покращені анімації popup, динамічні оберти
- v2.1: Повна підтримка підрозділів, імпорт з Excel листів, базові налаштування анімації
- v2.0: Автозбереження, експорт/імпорт, popup з привітаннями
