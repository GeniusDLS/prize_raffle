...
- **Основні підкаталоги**:
  - `.github/` - інструкції Copilot та документація (`copilot-instructions.md`, `PROGRESS.md`)
...
- **PATCH** (`v2.5.0` → `v2.5.1`): виправлення багів, косметичні зміни
- **MINOR** (`v2.5.0` → `v2.6.0`): нова функціональність (зворотньо сумісна)
- **MAJOR** (`v2.5.0` → `v3.0.0`): кардинальні зміни архітектури або UI
...
4. Поточна версія: **v2.5.0**

---

### Версія інструкцій: 2.0
### Дата оновлення: Березень 2026
### Базується на проекті Prize Raffle v2.5.0
